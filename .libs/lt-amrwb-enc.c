...
/* ./.libs/lt-amrwb-enc.c - temporary wrapper executable for .libs/amrwb-enc.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.1

   The amrwb-enc program cannot be directly executed until all the libtool
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.4.2 Debian-2.4.2-1.1\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# amrwb-enc - temporary wrapper script for .libs/amrwb-enc.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.1\n", f);
  fputs ("#\n", f);
  fputs ("# The amrwb-enc program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libvo-amrwbenc.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"amrwb-enc.exe:amrwb-enc:${LINENO}: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2 Debian-2.4.2-1.1\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"amrwb-enc.exe:amrwb-enc:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"amrwb-enc.exe:amrwb-enc:${LINENO}: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
